...
- Filtrer / rechercher des images selon différents critères
...
- Développement de fonctionnalités frontend en Vue.js / TypeScript (pages, composants, appels à l’API)
- Écriture et exécution de tests (JUnit / tests manuels via Postman)
- Utilisation de Git (branches, merge, rebase) pour collaborer avec l’équipe

## Structure du projet

- `backend/` : application Java Spring Boot (API REST, logique métier, accès base de données)
...
- Tests : présents mais perfectibles

Ce dépôt GitHub me sert de portfolio pour présenter ce projet lors de ma recherche d’alternance en développement web.
